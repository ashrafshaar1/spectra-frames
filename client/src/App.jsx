          ...
          <div className="container">
            ...
            <div className="footer-social">
              ...
              <a href="https://instagram.com/spectraframes" target="_blank" rel="noopener noreferrer" className="social-link instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4c0 3.2-2.6 5.8-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8C2 4.6 4.6 2 7.8 2zm-.2 2C5.6 4 4 5.6 4 7.8v8.4c0 2.2 1.6 3.8 3.8 3.8h8.4c2.2 0 3.8-1.6 3.8-3.8V7.8c0-2.2-1.6-3.8-3.8-3.8H7.6zm.4 2h8c.6 0 1 .4 1 1v8c0 .6-.4 1-1 1H8c-.6 0-1-.4-1-1V7c0-.6.4-1 1-1zm8 1H8v8h8V7zM12 9c1.7 0 3 1.3 3 3s-1.3 3-3 3-3-1.3-3-3 1.3-3 3-3zm0 2c-.6 0-1 .4-1 1s.4 1 1 1 1-.4 1-1-.4-1-1-1z"/>
                </svg>
              </a>
              <a href="https://tiktok.com/@spectraframes" target="_blank" rel="noopener noreferrer" className="social-link tiktok">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M16.6 5.82s.51.5 0 0A4.14 4.14 0 0 1 19 9.32c0 .34-.03.67-.08.99-.1.6-.3 1.17-.6 1.68-.2.33-.43.63-.68.92-.26.29-.55.54-.86.76-.32.22-.66.4-1.02.54-.35.14-.72.23-1.09.27-.38.04-.76.03-1.14-.02-.38-.05-.75-.16-1.1-.32-.34-.16-.66-.37-.94-.63-.28-.26-.52-.56-.71-.9-.19-.34-.33-.7-.42-1.08-.09-.38-.13-.77-.1-1.16.03-.38.11-.75.24-1.1.13-.35.3-.68.52-.98.22-.3.48-.56.77-.78.29-.22.6-.4.93-.53.33-.14.67-.23 1.02-.27.35-.04.7-.04 1.05.01.35.05.68.15 1 .3.32.15.61.35.87.59.25.24.46.52.63.83.17.31.29.64.36.99.07.35.08.7.05 1.05v.02l-.01.01c.26-.07.51-.17.75-.3.23-.13.45-.29.63-.48.18-.19.33-.41.44-.65.11-.24.18-.5.21-.76.03-.26.02-.52-.02-.78-.04-.26-.12-.51-.24-.74-.12-.23-.28-.44-.46-.62-.18-.18-.39-.33-.62-.44-.23-.11-.48-.19-.73-.23-.25-.04-.51-.04-.76 0-.25.04-.49.13-.72.25-.23.12-.44.29-.61.49-.17.2-.31.43-.4.68-.09.25-.14.51-.14.78 0 .27.04.53.12.78.08.25.2.48.36.68.16.2.35.37.57.5.22.13.46.22.71.27.25.05.51.06.76.03.25-.03.49-.11.72-.23v.02c-.03.59-.2 1.15-.48 1.65-.28.5-.66.93-1.1 1.27-.44.34-.95.58-1.5.72-.55.14-1.12.17-1.68.09-.56-.08-1.09-.28-1.57-.58-.48-.3-.89-.68-1.21-1.13-.32-.45-.55-.96-.67-1.5-.12-.54-.13-1.1-.03-1.64.1-.54.31-1.05.61-1.51.3-.46.69-.86 1.14-1.16.45-.3.96-.5 1.5-.58.54-.08 1.09-.06 1.63.06.54.12 1.04.34 1.49.65.45.31.83.71 1.13 1.17.3.46.51.97.61 1.51.1.54.11 1.1.02 1.64l-.01.01z"/>
                </svg>
              </a>
